...
`PASS` — package integrity, XML parsing, parameter membership, three LOD types, calculated-field
presence, dashboard-action presence, embedded-extract allowlist, and sensitive-marker scan.
